...
class ItemJualController extends Controller
{
	public function index()
	{
		...
		return view('Admin.item-jual.main',compact('title','page','treeview'));
	}
	...
	public function tambah()
	{
		...
		return view('Admin.item-jual.tambah',compact('title','page','treeview','jenis_item'));
	}
	...
	public function save(Request $request)
	{
		...
		return redirect('/admin/data-item-jual')->with('message','Berhasil Input Menu');
	}
	...
	public function edit($id)
	{
		...
		return view('Admin.item-jual.edit',compact('title','page','treeview','row','id','jenis_item'));
	}
	...
	public function update($id,Request $request)
	{
		...
		return redirect('/admin/data-item-jual')->with('message','Berhasil Edit Item Jual');
	}
	...
	public function delete($id)
	{
		...
		return redirect('/admin/data-item-jual')->with('message','Berhasil Hapus Item Jual');
	}
}
