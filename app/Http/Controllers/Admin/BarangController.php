...
class BarangController extends Controller
{
    ...
    public function tambah()
    {
		...
		return view('Admin.barang.tambah',compact('title','page','treeview','jenis_barang'));
    }
    ...
    public function save(Request $request)
    {
		...
		return redirect('/admin/data-barang')->with('message','Berhasil Input Barang');
    }
    ...
    public function edit($id)
    {
		...
		return view('Admin.barang.edit',compact('title','page','treeview','jenis_barang','row','id'));
    }
    ...
    public function update($id,Request $request)
    {
		...
		return redirect('/admin/data-barang')->with('message','Berhasil Update Barang');
    }
    ...
    public function delete($id)
    {
    	...
    	return redirect('/admin/data-barang')->with('message','Berhasil Hapus Barang');
    }
}
