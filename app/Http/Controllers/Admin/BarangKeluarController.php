...
class BarangKeluarController extends Controller
{
    ...
    public function tambah()
    {
		...
		return view('Admin.barang-keluar.tambah',compact('title','page','treeview','jenis_barang'));
    }
    ...
    public function save(Request $request)
    {
		...
		return redirect('/admin/data-barang-keluar')->with('message','Berhasil Input Barang Keluar');
    }
    ...
    public function detail($id)
    {
		...
		return view('Admin.barang-keluar.detail',compact('title','page','treeview'));
    }
}
