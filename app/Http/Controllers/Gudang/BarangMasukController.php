...
class BarangMasukController extends Controller
{
    public function index()
    {
		...
		return view('Gudang.barang-masuk.main',compact('title','page','treeview'));
    }
    ...
    public function tambah()
    {
		...
		return view('Gudang.barang-masuk.tambah',compact('title','page','treeview','supplier','jenis_barang'));
    }
    ...
    public function save(Request $request)
    {
		...
		return redirect('/gudang/data-barang-masuk')->with('message','Berhasil Input Barang Masuk');
    }
    ...
    public function detail($id)
    {
		...
		return view('Gudang.barang-masuk.detail',compact('title','page','treeview'));
    }
}
