...
class JenisBarangController extends Controller
{
    public function index()
    {
		...
		return view('Gudang.jenis-barang.main',compact('title','page','treeview'));
    }
    ...
    public function tambah()
    {
		...
		return view('Gudang.jenis-barang.tambah',compact('title','page','treeview'));
    }
    ...
    public function edit($id)
    {
		...
		return view('Gudang.jenis-barang.edit',compact('title','page','treeview','row','id'));
    }
