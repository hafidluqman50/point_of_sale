...
class LaporanInventoryController extends Controller
{
    public function laporanStokBarang()
    {
		...
		return view('Gudang.laporan-inventory.laporan-stok-barang',compact('title','page','treeview'));
    }
    ...
    public function laporanMutasiBarang()
    {
		...
		return view('Gudang.laporan-inventory.laporan-mutasi-barang',compact('title','page','treeview'));
    }
